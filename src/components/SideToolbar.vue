  ...
  <div class="w-16 h-full flex flex-col items-center py-6 glass-panel border-r-0 rounded-r-2xl mr-4 my-4 ml-4">
    ...
    <div class="flex-1 flex flex-col space-y-6 w-full px-2">
      ...
      >
        ...
        <!-- Tooltip -->
        <div class="absolute left-full ml-4 px-2 py-1 bg-gray-800 text-xs text-white rounded opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-50">
          {{ item.label }}
        </div>
